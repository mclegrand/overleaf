...
const MAPPINGS = {
    ...
    [CLOUD_RUN_REVISION]: {
        [LOCATION]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.CLOUD_REGION] },
        [SERVICE_NAME]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.FAAS_NAME] },
        [CONFIGURATION_NAME]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.FAAS_NAME] },
        [REVISION_NAME]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.FAAS_VERSION] },
    },
    [CLOUD_FUNCTION]: {
        [REGION]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.CLOUD_REGION] },
        [FUNCTION_NAME]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.FAAS_NAME] },
    },
    [GAE_INSTANCE]: {
        [LOCATION]: {
            otelKeys: [
        ...
        [GAE_MODULE_ID]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.FAAS_NAME] },
        [GAE_VERSION_ID]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.FAAS_VERSION] },
        [INSTANCE_ID]: { otelKeys: [semantic_conventions_1.SemanticResourceAttributes.FAAS_ID] },
    },
    [GENERIC_TASK]: {
        [LOCATION]: {
            otelKeys: [
...
function mapOtelResourceToMonitoredResource(resource, includeUnsupportedResources = false) {
    ...
    else if (platform === semantic_conventions_1.CloudPlatformValues.GCP_APP_ENGINE) {
    ...
    // Cloud Run and Cloud Functions are not writeable for custom metrics yet
        ...
        platform === semantic_conventions_1.CloudPlatformValues.GCP_CLOUD_RUN) {
        mr = createMonitoredResource(CLOUD_RUN_REVISION, attrs);
    }
    else if (includeUnsupportedResources &&
        platform === semantic_conventions_1.CloudPlatformValues.GCP_CLOUD_FUNCTIONS) {
