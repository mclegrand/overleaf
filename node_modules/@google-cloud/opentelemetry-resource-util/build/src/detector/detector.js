...
async function gkeResource() {
    ...
    return await makeResource({
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_PLATFORM]: semantic_conventions_1.CloudPlatformValues.GCP_KUBERNETES_ENGINE,
        [zoneOrRegion.type === 'zone'
            ? semantic_conventions_1.SemanticResourceAttributes.CLOUD_AVAILABILITY_ZONE
            : semantic_conventions_1.SemanticResourceAttributes.CLOUD_REGION]: zoneOrRegion.value,
        [semantic_conventions_1.SemanticResourceAttributes.K8S_CLUSTER_NAME]: k8sClusterName,
        [semantic_conventions_1.SemanticResourceAttributes.HOST_ID]: hostId,
    });
}
async function cloudRunResource() {
    ...
    return await makeResource({
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_PLATFORM]: semantic_conventions_1.CloudPlatformValues.GCP_CLOUD_RUN,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_NAME]: faasName,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_VERSION]: faasVersion,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_ID]: faasId,
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_REGION]: faasCloudRegion,
    });
}
async function cloudFunctionsResource() {
    ...
    return await makeResource({
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_PLATFORM]: semantic_conventions_1.CloudPlatformValues.GCP_CLOUD_FUNCTIONS,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_NAME]: faasName,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_VERSION]: faasVersion,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_ID]: faasId,
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_REGION]: faasCloudRegion,
...
async function gaeResource() {
    ...
    return await makeResource({
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_PLATFORM]: semantic_conventions_1.CloudPlatformValues.GCP_APP_ENGINE,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_NAME]: faasName,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_VERSION]: faasVersion,
        [semantic_conventions_1.SemanticResourceAttributes.FAAS_ID]: faasId,
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_AVAILABILITY_ZONE]: zone,
...
async function gceResource() {
    ...
    return await makeResource({
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_PLATFORM]: semantic_conventions_1.CloudPlatformValues.GCP_COMPUTE_ENGINE,
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_AVAILABILITY_ZONE]: zoneAndRegion.zone,
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_REGION]: zoneAndRegion.region,
        [semantic_conventions_1.SemanticResourceAttributes.HOST_TYPE]: hostType,
        [semantic_conventions_1.SemanticResourceAttributes.HOST_ID]: hostId,
...
async function makeResource(attrs) {
    ...
    return new resources_1.Resource({
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_PROVIDER]: semantic_conventions_1.CloudProviderValues.GCP,
        [semantic_conventions_1.SemanticResourceAttributes.CLOUD_ACCOUNT_ID]: project,
        ...attrs,
    });
}
/**
